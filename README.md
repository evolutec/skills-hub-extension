...
<table>
  ...
  <tr>
    <td width="32%" valign="middle" style="font-size: 1.03rem; line-height: 1.45; padding: 8px 10px;">
      <strong style="font-size: 1.08rem;">Middle card - skills-discovery (skills_discovery)</strong><br/>
      No agent has this skill.
    </td>
  </tr>
  <tr>
    <td width="32%" valign="middle" style="font-size: 1.03rem; line-height: 1.45; padding: 8px 10px;">
      <strong style="font-size: 1.08rem;">Bottom card - docx</strong><br/>
      Only three agents have this skill.
    </td>
  </tr>
</table>

<p><em>Green highlighted agent icons indicate the skill is installed for that agent.</em></p>
